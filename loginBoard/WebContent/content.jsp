...
<div class="contentWrap">
	...
	<div class="footMenu">
	<c:choose>
		<c:when test="${idSession == bDto.id}">
		<ul>
			<li><input type="button" value="수정" onclick="javascript:window.location='modifyView.bdo?num=${bDto.num}'"></li>
			<li><input type="button" value="삭제" onclick="javascript:window.location='delete.bdo?num=${bDto.num}'"></li>
